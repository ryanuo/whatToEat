<!-- https://github.com/unovue/inspira-ui/blob/2540e89663b09d983319577f75400f1ccf1f9f4c/components/content/inspira/ui/fluid-cursor/FluidCursor.vue#L5 -->
...
onMounted(() => {
  ...
  function handleFirstTouchStart(e: TouchEvent) {
    ...
    for (let i = 0; i < touches.length; i++) {
      const posX = scaleByPixelRatio(touches[i]!.clientX as number)
      const posY = scaleByPixelRatio(touches[i]!.clientY as number)
      updateFrame()
...
<template>
  <div
    class="size-full pointer-events-none left-0 top-0 fixed z-50"
    :class="props.class"
  >
    <canvas
      id="fluid"
